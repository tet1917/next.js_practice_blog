  ...
  return (
    <div className='min-h-screen py-8 px-4 md:px-12'>
      ...
      <form action="" className="bg-slate-200 p-6 rounded shadow-lg">
        <div className='mb-4'>
            <label htmlFor="" className="text-gray-700 font-bold text-sm mb-2">URL</label>
            <input type="text" className="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none" />
        </div>
        <div className='mb-4'>
            <label htmlFor="" className="text-gray-700 font-bold text-sm mb-2">タイトル</label>
            <input type="text" className="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none" />
        </div>
        <div className='mb-4'>
            <label htmlFor="" className="text-gray-700 font-bold text-sm mb-2">本文</label>
